...
Initialize your Convex project (you'll be prompted to log in):
...
- Generate type-safe API bindings in `packages/backend/convex/_generated/`
...
Then update `apps/web/.env.local` with your Convex URL (shown after running `convex dev`):
...
This starts the Next.js dev server. Open [http://localhost:3000](http://localhost:3000).
